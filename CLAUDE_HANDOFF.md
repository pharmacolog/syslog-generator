...
Дата: 2026-07-13. Текущая версия: **v10.2.0** (compile-verified, Performance ч.2: hot-path оптимизация faker — `String::with_capacity` + `write!` для всех `faker.*`; -26% throughput на `generate_message_from_template` bench).
...
Текущее состояние: версия v10.2.0. **Веха F («Production-hardened») в процессе.** Сделанные релизы: вехи A/B/C/D (v8.0.0, v9.0.0) + вехи E (v9.1.0-v9.6.0) + **v10.0.0 + v10.1.0 + v10.2.0** (старт вехи F: breaking cleanup + Performance ч.1+ч.2 + CLI split). Следующие релизы вехи F: v10.3.0 (cov ч.1), v10.4.0 (cov ч.2), v10.5.0 (CI), v10.6.0 (usability ч.1), v10.7.0 (usability ч.2 + закрытие вехи F). План в `PLAN-v10.0.0.md` (8 релизов с контрактом приёмки из 21 пункта). История вехи E в `PLAN-веха-E.md`.
Все P1-задачи (F11/F12/F13/N4/N7/N9/D3/N2/N5/N8/N11) выполнены. Все P2-задачи вехи E (N10/F15/F16/F17/N4.cipher_policy/N12) выполнены. Сделанная часть вехи F: v10.0.0 (breaking cleanup), v10.1.0 (Performance ч.1 + B5), v10.2.0 (Performance ч.2: faker hot-path). Оставшиеся: v10.3.0-v10.7.0.
