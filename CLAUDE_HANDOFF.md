...
Дата: 2026-07-12. Текущая версия: **v8.4.0** (compile-verified).
...
- **v8.4.0** — веха D: N9 (CI-пайплайн на GitHub Actions). ← текущая.
...
`syslog-generator-v8.4.0-verified.zip` (или распакованный проект). При работе в Claude Code
...
Текущее состояние: версия v8.4.0. Веха D («Продакшн-готовность») в работе; закрыты
...
с тестами и выпусти v8.5.0 по чек-листу.
...
> Архив — `syslog-generator-v8.4.0-verified.zip` (текущая версия). Если хочешь начать не с D3, а с другой
