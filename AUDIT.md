...
> **Статус на v9.0.0 (2026-07-13):** вехи A, B и C закрыты полностью (v8.0.0).
> **Веха D (P1) закрыта полностью (v9.0.0 — milestone release).** Закрыты
