...
Дата: 2026-07-13. Текущая версия: **v10.3.0** (compile-verified, Coverage ч.1: `cargo-llvm-cov` baseline **86.40% lines / 88.36% functions / 86.49% regions** + non-blocking CI coverage job + `docs/COVERAGE.md` с планом v10.4.0).
