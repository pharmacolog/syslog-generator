...
Дата: 2026-07-21 (выпущен v10.7.17, planning v10.7.21). Текущая версия: **v10.7.17** на main (`e28b461`). Следующий minor release: **v10.7.21** — RESERVED, будет cut как release/v10.7.21 branch от v10.7.16 commit (FF). См. `git notes --ref=v10.7.16 show v10.7.16` для деталей. PR-17a..e hot-path optimization bundle в v10.7.16. **PR-58** — Phase 13 TCP reconnect race fix (`9c55f55`) → выпущен в v10.7.17 как patch-release. Benchmark: **1690.6 нс/msg (−17.8% от v10.7.15)**, throughput 591 Kelem/s (+21.6%). Coverage: 92.86/92.45/92.91% (lines/functions/regions) на v10.7.16; **93.63/93.76** на v10.7.17 (после Phase 13 фикса `transport/tcp.rs`). 391 tests pass (было 328 в v10.7.16 — +63 proptest на Phase 9); clippy clean. **Release train v10.7.17 завершён**: PR #60 (merge e28b461) → main → tag v10.7.17 → GitHub Release. **Protocol для будущих releases** (см. CLAUDE_HANDOFF §6): feature → dev → release/vX.Y.Z → main → tag.
